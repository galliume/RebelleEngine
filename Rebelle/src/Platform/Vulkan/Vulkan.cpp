...
static std::vector<char> readFile(const std::string& filename)
{
    ...
    if (!file.is_open())
    {
        RBL_CORE_FATAL("Can't open file {0}", filename);
    }
    size_t fileSize = (size_t)file.tellg();
    RBL_CORE_TRACE("File size {0}", fileSize);
...
namespace Rebelle {    
    ...
    Vulkan::Vulkan()
    {
        RBL_CORE_ASSERT(!s_Instance, "Vulkan already exists");
    ...
    void Vulkan::createInstance()
    {
        ...
        appInfo.pEngineName = "RebelleEngine";
        ...
        {
            RBL_CORE_TRACE("Vulkan Instance created");
        }
    }
    void Vulkan::createGraphicsPipeline() 
    {
        auto vertShaderCode = readFile("C:/Users/Guillaume/Documents/workspace/RebelleEngine/shaders/vert.spv");
        auto fragShaderCode = readFile("C:/Users/Guillaume/Documents/workspace/RebelleEngine/shaders/frag.spv");
        ...
        {
            RBL_CORE_FATAL("Can't create layout pipeline");
        }
        ...
        {
            RBL_CORE_FATAL("Can't create graphic pipeline");
        }
    ...
    void Vulkan::createImageViews() 
    {
        ...
        for (size_t i = 0; i < swapChainImages.size(); i++) 
        {
            ...
            {
                RBL_CORE_FATAL("Can't create image view");
            }
        }
    }
    void Vulkan::createSwapChain() 
    {
        ...
        {
            RBL_CORE_FATAL("Can't create swap chain");
        }
    ...
    void Vulkan::createSurface()
    {
        ...
        {
            RBL_CORE_FATAL("Can't create the surface");
        }
        else
        {
            RBL_CORE_INFO("Surface created");
        }
    }
    ...
    void Vulkan::createLogicalDevice() 
    {
        ...
        {
            RBL_CORE_FATAL("Can't create logical device");
        }
    ...
    void Vulkan::pickPhysicalDevice()
    {
        ...
        if (deviceCount == 0) 
        {
            RBL_CORE_FATAL("No compatible GPU found");
        }
        ...
        if (physicalDevice == VK_NULL_HANDLE) {
            RBL_CORE_FATAL("No GPU can run this program");
        }
    }
    ...
    VkShaderModule Vulkan::createShaderModule(const std::vector<char>& code) 
    {
        ...
        {
           RBL_CORE_FATAL("Can't create module shader");
        }
        return shaderModule;
    }
    ...
    void Vulkan::createGraphicsPipline()
    {
        ...
        if (vkCreatePipelineLayout(device, &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS) 
        {
            RBL_CORE_FATAL("Can't create pipeline layout");
        }
    }
    ...
    void Vulkan::createRenderPass()
    {
        ...
        {
            RBL_CORE_FATAL("Can't create render pass");
        }
    }
    ...
    void Vulkan::createFramebuffers()
    {
        ...
        for (size_t i = 0; i < swapChainImageViews.size(); i++) 
        {
            ...
            {
                RBL_CORE_FATAL("Can't create framebuffer");
            }
        }
    }
    ...
    void Vulkan::createCommandPool() 
    {
        ...
        {
            RBL_CORE_FATAL("Can't create command pool");
        }
    }
    void Vulkan::createCommandBuffers() 
    {
        ...
        {
            RBL_CORE_FATAL("Can't allocate command buffer");
        }
        ...
        for (size_t i = 0; i < commandBuffers.size(); i++) 
        {
            ...
            {
                RBL_CORE_FATAL("Can't begin command buffer");
            }
            ...
            {
                RBL_CORE_FATAL("Can't end command buffer");
            }
        }
    }
    ...
    void Vulkan::createSyncObjects()
    {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphores[i]) != VK_SUCCESS ||
                ...
                RBL_CORE_FATAL("failed to create synchronization objects for a frame!");
            }
        }
    }
    void Vulkan::drawFrame()
    {
        ...
        {
            RBL_CORE_FATAL("Can't present image to the swap chain");
        }
        ...
        {
            RBL_CORE_FATAL("failed to submit draw command buffer!");
        }
        ...
        {
            RBL_CORE_FATAL("Can't present image");
        }
    ...
    uint32_t Vulkan::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
    {
        ...
        RBL_CORE_FATAL("failed to find suitable memory type");
    }
    ...
    void Vulkan::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
    {
        ...
        {
            RBL_CORE_FATAL("failed to create buffer");
        }
        ...
        {
            RBL_CORE_FATAL("failed to allocate buffer memory");
        }
    ...
    void Vulkan::createDescriptorSetLayout()
    {
        ...
        {
            RBL_CORE_FATAL("failed to create descriptor set layout");
        }
    }
    ...
    void Vulkan::createDescriptorPool()
    {
        ...
        {
            RBL_CORE_FATAL("failed to create descriptor pool");
        }
    }
    ...
    void Vulkan::createDescriptorSets() 
    {
        ...
        {
            RBL_CORE_FATAL("failed to allocate descriptor sets");
        }
